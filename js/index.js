...
var swiper = new Swiper(".influencers-video-swiper", {
  slidesPerView: 3,
  spaceBetween: 30,
  slidesPerGroup: 1,
  loop: true,
...
"videoads": [
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/1afb25a2-dd4a-4e38-b60f-99a57a57c623/Thumbnails/Screen_Recording_20220729-021304_Instagram.0000000.jpg",
    brandLogoSrc: ""
  },
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/2876bf75-2426-4e5b-9f83-932b551ca1dd/Thumbnails/RPReplay_Final1658308193.0000000.jpg",
    brandLogoSrc: ""
  },
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/43973e98-c37c-4e0a-8318-73b5363bb11c/Thumbnails/Screen_Recording_20220729-015525_Instagram.0000000.jpg",
    brandLogoSrc: ""
  },
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/749e3d89-acb6-43f8-b68e-89addd219cfd/Thumbnails/Screen_Recording_20220729-020823_Instagram.0000000.jpg",
    brandLogoSrc: ""
  },
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/76675154-3339-4b8e-b9bf-8f8de75c852e/Thumbnails/Screen_Recording_20220729-021304_Instagram.0000000.jpg",
    brandLogoSrc: ""
  },
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/af7118d7-0933-47af-a9d3-74b955d59f5c/Thumbnails/RPReplay_Final1658315697.0000000.jpg",
    brandLogoSrc: ""
  },
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/c763a9ba-8e8f-4ff5-83ef-e8dc9e769fef/Thumbnails/RPReplay_Final1658313690.0000000.jpg",
    brandLogoSrc: ""
  },
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/dd205989-3bcd-4c7d-8665-5d94f7a8e8eb/Thumbnails/RPReplay_Final1658311494.0000000.jpg",
    brandLogoSrc: ""
  },
  {
    ...
    parentId: "videoads",
    poster: "https://drl5d07sf56ow.cloudfront.net/assets/f826ee45-3a27-42b0-af47-4487c51acaa0/Thumbnails/Screenrecorder-2022-07-26-18-01-45-938.0000000.jpg",
    brandLogoSrc: ""
  },
]
  };
    ...
    worker.addEventListener(
      ...
      async function(event) {
        ...
        const imagePromises = event.data.map(async vid => {
          if (vid.url) {
            const response = await createVideo(vid);
            return response;
          }
        });
...
document.addEventListener('DOMContentLoaded', async () => {
  if (window.location.href.includes("video-ads")) {
  await resolveImages(videos, "videoads");
  } else {
  await resolveImages(videos, "fashion");
  await resolveImages(videos, "beauty");
  await resolveImages(videos, "edtech");
  await resolveImages(videos, "finance");
  await resolveImages(videos, "fitness");
  await resolveImages(videos, "food");
  await resolveImages(videos, "funny");
  await resolveImages(videos, "tech");
  await resolveImages(videos, "travel");
  }
})
