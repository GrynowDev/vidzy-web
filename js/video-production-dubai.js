function readMoreLess() {
  ...
  document.addEventListener('readystatechange', async (event) => {
    ...
    if (window.location.href.includes("video-ads") || window.location.href.includes("shopify-stores") || window.location.href.includes("video-production-company-in-dubai-uae")) {
